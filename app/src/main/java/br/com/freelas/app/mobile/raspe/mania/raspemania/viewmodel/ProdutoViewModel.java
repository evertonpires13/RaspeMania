...
public class ProdutoViewModel extends BaseViewModel implements GenericInterface {
    ...
    /*--------------------------------------------------------------------------------------------*/
    public ProdutoViewModel(Context context, ProdutoComponente produtoComponente) {
